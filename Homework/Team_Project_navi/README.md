...
## <소감>
- **정용진** : 전체적으로 팀프로젝트를 통해 큰 프로그램을 작성하며 사용한 알고리즘 및 외부 라이브러리 사용에 대해 조금 더 이해를 하게 되었고 UI의 배치와 사용자의 조작감 등 추후에 있을 프로젝트를 제작하기에 앞서 실력 증진이 있었다고 생각한다.    
- **이동희** : 처음..팀프로젝트를 해보면서 어떻게해야할지 감을 못잡고  도움도 잘안됐지만 팀원들 덕분에 해낼 수 있었습니다...  
- **강무석** : 이번 프로젝트 주제인 네비게이션은 상당히 어려웠던 주제 같습니다. 하지만 팀원분들과 함께 하나씩 구현해 나가면서 뿌듯함을 느꼈습니다.  
- **이종모** : 팀프로젝트를 사실상 처음 해봤는데 뭘 해야될지 감도 안잡혔고 아무것도 안한 거 같은데 팀원분들이 잘 이끌어주셔서 뭔가 할 수 있었던 거 같습니다  
- **최정원** : 이번 미니프로젝트 팀플을 하면서 어려움도 많이 느꼈지만 많은걸 배웠습니다. 알고리즘 또한 프로젝트에 적용시키는게 처음이여서 많이 어려웠지만 팀원들의 도움으로 이번 프로젝트 적용시킬 수 있었던 거 같습니다.
